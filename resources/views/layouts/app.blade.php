    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="{{ route('home') }}" class="brand-link">
                <i class="fas fa-industry brand-image ml-2"></i>
                <span class="brand-text font-weight-light ml-2">CNC System</span>
            </a>
            <div class="sidebar">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                ...
                                <p>Quotes <i class="right fas fa-angle-left"></i></p>
                            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} CNC System.</strong> All rights reserved.
        </footer>
    </div>
