...
<form method="POST" 
      action="{{ route('company.vendors.update', $vendor->id) }}" 
      enctype="multipart/form-data" 
      id="vendorForm"
      data-has-logo="{{ $vendor->logo ? '1' : '0' }}">
    @csrf
    @method('PUT')
    ...
    <div class="card card-warning">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-edit"></i> Edit Vendor: {{ $vendor->name }}
            </h3>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="payment_terms_days" class="form-control"
                            value="{{ old('payment_terms_days', $vendor->payment_terms_days) }}" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="lead_time_days" class="form-control"
                            value="{{ old('lead_time_days', $vendor->lead_time_days) }}">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <!-- Current Logo -->
                        <div class="mb-2" id="currentImage" style="{{ $vendor->logo ? '' : 'display: none;' }}">
                            <img id="currentImg" src="{{ $vendor->logo_url }}" alt="{{ $vendor->name }}"
                        ...
                        <div class="custom-file" id="fileInputWrapper" style="{{ $vendor->logo ? 'display: none;' : '' }}">
                    ...
                    <div>
                        ...
                        @php
                            ...
                            if ($address->address_type === 'billing') {
                                $billingCount = $vendor->addresses->where('address_type', 'billing')->count();
                                if ($billingCount <= 1) {
                                    $canDelete = false;
                                }
                            }
                        ...
                        <button type="button" class="btn btn-danger btn-sm delete-address-btn"
                                data-url="{{ route('company.vendors.delete-address', [$vendor->id, $address->id]) }}">
    ...
    <div class="card">
        <div class="card-footer">
            ...
            <a href="{{ route('company.vendors.show', $vendor->id) }}" class="btn btn-info btn-lg">
...
<div class="modal fade" id="addAddressModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="POST" action="{{ route('company.vendors.add-address', $vendor->id) }}" id="addAddressForm">
                @csrf
...
$(document).ready(function() {
    var hasLogo = $('#vendorForm').data('has-logo') == '1';
    ...
    $(document).on('click', '.edit-address-btn', function(e) {
        ...
        var updateUrl = '{{ route("company.vendors.update-address", [$vendor->id, "ADDRESS_ID"]) }}';
