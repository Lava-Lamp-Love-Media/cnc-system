...
<form method="POST" action="{{ route('company.materials.update', $material->id) }}" id="materialForm">
    @csrf
    @method('PUT')
    ...
    <div class="card card-warning">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-edit"></i> Edit Material — {{ $material->name }}
            </h3>
        </div>
        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="type" class="form-control @error('type') is-invalid @enderror" required>
                            <option value="metal_alloy" {{ old('type', $material->type) == 'metal_alloy' ? 'selected' : '' }}>Metal / Alloy</option>
                            <option value="plastic"     {{ old('type', $material->type) == 'plastic'     ? 'selected' : '' }}>Plastic</option>
                            <option value="composite"   {{ old('type', $material->type) == 'composite'   ? 'selected' : '' }}>Composite</option>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="unit" class="form-control @error('unit') is-invalid @enderror" required>
                            <option value="mm"   {{ old('unit', $material->unit) == 'mm'   ? 'selected' : '' }}>mm</option>
                            <option value="inch" {{ old('unit', $material->unit) == 'inch' ? 'selected' : '' }}>inch</option>
                        </select>
                        @error('unit')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.00001" name="diameter_from"
                            ...
                            value="{{ old('diameter_from', $material->diameter_from) }}" required>
                        @error('diameter_from')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.00001" name="diameter_to"
                            ...
                            value="{{ old('diameter_to', $material->diameter_to) }}" required>
                        @error('diameter_to')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="density"
                            ...
                            value="{{ old('density', $material->density) }}" required>
                        @error('density')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select name="adj_type" id="adjType"
                            ...
                            required onchange="calcRealPrice()">
                            <option value="amount"  {{ old('adj_type', $material->adj_type) == 'amount'  ? 'selected' : '' }}>Amount ($)</option>
                            <option value="percent" {{ old('adj_type', $material->adj_type) == 'percent' ? 'selected' : '' }}>Percent (%)</option>
                        </select>
                        @error('adj_type')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.0001" name="adj" id="adjInput"
                                ...
                                value="{{ old('adj', $material->adj) }}"
                                onchange="calcRealPrice()">
                        </div>
                        @error('adj')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="realPriceDisplay"
                                ...
                                readonly value="{{ old('real_price', $material->real_price) }}">
                        </div>
                        <input type="hidden" name="real_price" id="realPriceInput"
                               value="{{ old('real_price', $material->real_price) }}">
            ...
            <div class="form-group">
                ...
                <textarea name="notes" class="form-control" rows="3"
                    placeholder="Optional notes about this material specification">{{ old('notes', $material->notes) }}</textarea>
            </div>
